...
////// SET BOSH_SERVICE_URL TO PUNJAB CONNECTION MANAGER
        // this.bosh_service_url = "http://localhost:5280";
        //original code sets bosh_service_url to undefined
...
// ====================
        ...
        _.extend(this, _.pick(settings, [
            ...
            'xhr_user_search',
            'xhr_user_search_url',
            'FB'        // Facebook object passed in
        ]));

/////////
        // Emitted at end of initialization
        converse.on('onInitialized', function() {
            console.log("Converse.js initialized");
            connectToFacebook(converse);
        });
        ...
        this.onConnect = function (status, condition, reconnect) {
            ...
            // Print lines to indicate status
            ...
            if ((status === Strophe.Status.CONNECTED) ||
                ...
                converse.log("Status: DISCONNECTING");
...
////////////////////////
        ...
        this.LoginPanel = Backbone.View.extend({
            ...
            connect: function() {
                // =========== Custom code in connectToFacebook; Original code commented out ===============
                console.log('Deprecated: LoginPanel.connect called -- Call connectToFacebook instead.');
                /*i
                f ($form) {
                    $form.find('input[type=submit]').hide().after('<span class="spinner login-submit"/>');
                }
                //this is original connection code; do I still need it?
...
/// ================= ORIGINAL AUTHENTICATION COMMENTED OUT =========
               /* var $form = $(ev.target),
                ...
                console.log('Deprecated: LoginPanel.authenticate called on Login Submit button');
                return false;
            },
...
/* Called from converse.on('onInitialize') */
function connectToFacebook(converse) {
    // Create Strophe connection to BOSH server
    converse.connection = new Strophe.Connection(converse.bosh_service_url);
    var FB = converse.FB;
    // Get Username from FB object, then log in
    FB.api('/me', function(response) {
        // jid = username@chat.facebook.com
        var jid = response.username + '@' + 'chat.facebook.com';
        console.log('-- Connecting to Facebook for ' + jid);
        // Facebook.js calls
        converse.connection.facebookConnect(
            //jid, callback, wait, hold, apiKey, secretKey, sessionKey
            jid,
            converse.onConnect,
            60,
            1,
            '610602015680966',                  // API_KEY
            '1a0eb427f36d45a0e81e3bb52c7a1245',
            FB.getAccessToken()
        ); 
    });
}
...
// ============================================================================
// =================== STROPHE FACEBOOK.JS PLUGIN METHODS =====================
// ============================================================================


// ======================== FACEBOOK CONNECT PLUGIN METHODS ==================
/**
...
Strophe.Connection.prototype._sasl_challenge1_fb = function (elem)
    {
////////////
console.log("_sasl_challenge1_fb CALLED START");
...
//////////
console.log("_sasl_challenge1 CALL I");
...
//////////
console.log("_sasl_challenge1 CALL II");
...
//////////
// console.log("_sasl_challenge1 CALL III");
...
//////////
console.log("_sasl_challenge1 CALL III.1");
...
////////
console.log("_sasl_challenge1 CALL IIII");
...
////////
console.log("_sasl_challenge1 FINISH");
...
///////
console.log("_connect_fb CALLED");
...
///////
console.log("_connect_fb FINISH");
};
...
/////////
console.log('FACEBOOK.JS facebookConnect called!!!');
...
//////////
console.log("facebookConnect II");
};

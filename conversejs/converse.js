...
////// SET BOSH_SERVICE_URL TO PUNJAB CONNECTION MANAGER
        ...
        this.ControlBoxView = converse.ChatBoxView.extend({
            ...
            render: function () {
////////////
    console.log("---- converse.js render() values");
    console.log("------- converse.prebind: " + converse.prebind);
    console.log("------- converse.connection: " + converse.connection);
////////////^^^^^
...
/*
console.log("before facebookConnect (converse.js: connect)");
//////////////
//////////////
//////// THIS IS WHAT I ADDED FOR FACEBOOK PLUGIN -- STILL NEED TO EDIT FOR USERNAME AND SESSION KEY
                connection.facebookConnect(
                    //jid, callback, wait, hold, apiKey, secretKey, sessionKey
                    "michael.weinstein.39@chat.facebook.com",
                    onConnectFacebook,
                    300,
                    1,
                    '825013770847053',
                    '507fcd527167782055f00c1ec2a07f0a',
                    FB.getSession().session_key
                );                

console.log("after facebookConnect"); */
